...
BEGIN
	...
	-- 重复领取
	IF exists(SELECT * FROM QPAccountsDBLink.QPAccountsDB.dbo.AccountsTask 
	...
	SELECT @TaskTakeMaxCount=StatusValue FROM QPAccountsDBLink.QPAccountsDB.dbo.SystemStatusInfo WHERE StatusName=N'TaskTakeCount'	
	...
	SELECT @TaskTakeCount=Count(*) FROM QPAccountsDBLink.QPAccountsDB.dbo.AccountsTask 
	...
	-- 插入任务
	INSERT INTO QPAccountsDBLink.QPAccountsDB.dbo.AccountsTask(UserID,TaskID,TaskType,TaskObject,KindID,TimeLimit) 
