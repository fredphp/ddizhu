...
BEGIN
	...
	BEGIN
		SET @strNotifyContent = N'您的金豆不低于 '+CAST(@ScoreCondition AS NVARCHAR)+N'，不可领取！'	
		RETURN 1	
	END	
	...
	--插入记录
	INSERT INTO QPTreasureDBLink.QPRecordDB.dbo.RecordBaseEnsure(UserID,BaseEnsureGold,ClientID,TakeTime,OldGold,NewGold,OldInsureGold,NewInsureGold)
