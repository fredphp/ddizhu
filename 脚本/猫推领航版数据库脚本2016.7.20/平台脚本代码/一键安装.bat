...
osql -E -i "%rootPath%1_3_金豆库脚本.sql"
...
osql -E -i "%rootPath%2_3_金豆库脚本.sql"
...
osql -E -i "%rootPath%抽奖配置.sql"
osql -E -i "%rootPath%抽奖参数.sql"
...
osql -E  -i "%rootPath%身份证验证.sql"
osql -E  -i "%rootPath%清理日志.sql"
osql -E  -i "%rootPath%手机救济金.sql"
...
osql -E  -i "%rootPath%邮件系统.sql"
osql -E  -i "%rootPath%清理日志.sql" 
osql -E  -i "%rootPath%账户提款.sql"
osql -E  -i "%rootPath%手机任务.sql"
osql -E  -i "%rootPath%游戏控制.sql" 
