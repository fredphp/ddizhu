...
BEGIN
	...
	SELECT @RewardGold=RewardGold FROM QPPlatformDBLink.QPPlatformDB.dbo.SigninConfig WHERE DayID=@SeriesDate
	...
	-- 写入记录
	INSERT INTO QPRecordDBLink.QPRecordDB.dbo.RecordSignin(UserID,RewardGold,ClientID,InputDate) 
