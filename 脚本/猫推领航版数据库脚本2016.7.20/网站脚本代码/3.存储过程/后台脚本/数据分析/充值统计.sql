...
BEGIN
	...
	-- 用户总数
	SELECT @UserTotal=COUNT(UserID) FROM QPAccountsDBLink.QPAccountsDB.dbo.AccountsInfo WHERE IsAndroid=0
	
	-- 充值用户流失数
	SELECT @PayUserOutflowTotal=Count(UserID) FROM QPAccountsDBLink.QPAccountsDB.dbo.AccountsInfo 
