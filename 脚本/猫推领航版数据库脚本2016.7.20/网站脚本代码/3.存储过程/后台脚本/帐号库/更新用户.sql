...
BEGIN
	...
	IF @OldAccounts<>@strAccounts
	BEGIN
		INSERT INTO QPRecordDBLink.QPRecordDB.DBO.RecordAccountsExpend(OperMasterID,UserID,ReAccounts,[Type],ClientIP,CollectDate)
	...
	BEGIN
		INSERT INTO QPRecordDBLink.QPRecordDB.DBO.RecordPasswdExpend(OperMasterID,UserID,ReLogonPasswd,ReInsurePasswd,ClientIP,CollectDate)
