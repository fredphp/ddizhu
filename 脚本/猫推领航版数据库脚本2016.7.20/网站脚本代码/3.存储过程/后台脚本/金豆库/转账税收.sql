...
BEGIN
	...
	(SELECT Accounts FROM QPAccountsDBLink.QPAccountsDB.dbo.AccountsInfo WHERE UserID=SourceUserID) AS Accounts,
	(SELECT NickName FROM QPAccountsDBLink.QPAccountsDB.dbo.AccountsInfo WHERE UserID=SourceUserID) AS NickName,
	(SELECT GameID FROM QPAccountsDBLink.QPAccountsDB.dbo.AccountsInfo WHERE UserID=SourceUserID) AS GameID
