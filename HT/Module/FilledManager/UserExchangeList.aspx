<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserExchangeList.aspx.cs" Inherits="MTEwin.Module.FilledManager.UserExchangeList" %>
...
<body>
  <form id="form1" runat="server">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
      <tr>
        ...
        <td width="1232" height="25" valign="top" align="left">你当前位置：充值系统 - 兑换管理
        </td>
      </tr>
    </table>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
      <tr>
        <td class="listTdLeft" style="width: 80px">兑换金额：
        </td>
        <td>
          ...
          <asp:DropDownList ID="ddlStatus" runat="server">
            ...
            <asp:ListItem Value="2" Text="已拒绝"></asp:ListItem>
    ...
    <div id="content">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
        <tr align="center" class="bold">
          ...
          <td class="listTitle2">应得金额
          </td>
          <td class="listTitle2">帐号类型
          </td>
          <td class="listTitle2">账户号
          </td>
          <td class="listTitle2">账户名
          </td>
          <td class="listTitle2">银行名称
          </td>
          <td class="listTitle2">银行地址
          </td>
          ...
          <ItemTemplate>
            <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
              ...
              <td style="width: 100px;">
                <a class="l" href="UserExchangeProcess.aspx?param=<%#Eval("RecordID")+"&user="+Eval("Accounts") %>">审核</a>
              </td>
              <td>
                <%# Eval("CollectDate")%>
              </td>
              ...
              <td>
                <%# GetAccountTypeName((int)Eval("AccountType"))%>
              </td>
              <td>
                <%# Eval("AccountNo")%>
              </td>
              ...
              <td>
                <%#Eval("ApplyStatus").ToString() == "1" ? "已处理" : Eval("ApplyStatus").ToString() == "2" ? "<span style='color:Blue;'>已拒绝</span>" : Eval("ApplyStatus").ToString() == "3" ? "已提现" : "<span class='hong'>申请中</span>"%>
              </td>
              <td>
                <%# Eval("DealDate")%>
              </td>
  ...
  <script type="text/javascript">
    ...
    function getres() {
      if(str=="") return;
      $.ajax({
        url: '/Tools/Operating.ashx?action=reflashUserExchange&id='+str,
        type: 'get',
        dataType: 'json',
