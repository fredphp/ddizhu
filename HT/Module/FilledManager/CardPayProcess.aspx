<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardPayProcess.aspx.cs" Inherits="MTEwin.Module.FilledManager.CardPayProcess" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">你当前位置：充值系统 - 申请充值 </td>
        </tr>
    </table>
        ...
        <tr>
            <tr>
                <td class="titleOpBg Lpd10">
                    <input type="button" value="返回" class="btn wd1" onclick="Redirect('UserPaySysCard.aspx')" />                           
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        <tr>
            <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10"><div class="hg3  pd7">
                <asp:Literal ID="litInfo" runat="server"></asp:Literal>处理信息</div></td>
        </tr>
        <tr>
