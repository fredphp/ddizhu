<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnLineOrderList.aspx.cs" Inherits="MTEwin.Module.FilledManager.OnLineOrderList" %>
...
<body>
  <form id="form1" runat="server">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
      <tr>
        <td class="listTdLeft" style="width: 80px">订单金额：
        </td>
        <td>
          <asp:Literal ID="ltPayTotal" runat="server"></asp:Literal>
          ...
          至
                <asp:TextBox ID="txtEndDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtStartDate\')}'})"></asp:TextBox><img
                  ...
                  style="cursor: pointer; vertical-align: middle" />
          <asp:DropDownList ID="ddlGlobalShareInfo" runat="server" Visible="false">
          </asp:DropDownList>
          <asp:DropDownList ID="ddlOrderStatus" runat="server">
            ...
            <asp:ListItem Value="2" Text="完成"></asp:ListItem>
          </asp:DropDownList>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg Tmg7">
      <tr>
        <td class="listTdLeft" style="width: 80px">订单(账号)查询：
        </td>
        <td>
    ...
    <div id="content">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
        <tr align="center" class="bold">
          ...
          <td class="listTitle2">实付金额
          </td>
          <td class="listTitle2">订单状态
          </td>
          <td class="listTitle2">充值地址
          </td>
          <td class="listTitle1">操作用户
          </td>
        </tr>
        <asp:Repeater ID="rptOnLineOrder" runat="server">
          <ItemTemplate>
            <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
              ...
              <td>
                <%# GetOnLineOrderStatus((byte)Eval("OrderStatus"),Eval("OnLineID").ToString())%>
              </td>
              <td title=" <%# Eval( "IPAddress" ).ToString( )%>">
                <%# Game.Utils.IPQuery.GetAddressWithIP( Eval( "IPAddress" ).ToString( ) )%>
              </td>
              <td>
                <%# (int)Eval("OperUserID") == (int)Eval("UserID") ? GetAccounts((int)Eval("UserID")) : GetAccounts((int)Eval("OperUserID"))%>
              </td>
            </tr>
          </ItemTemplate>
    ...
    <div style="display: none;">
      <asp:Button runat="server" ID="OnLineType" Text="订单状态" OnClick="btnOnLineType_Click" />
    </div>
  </form>
</body>
</html>
<script type="text/javascript">
    function free(OnLineID)
    {
        if (confirm("是否修改订单状态？")) {
            $("#hid").val(OnLineID);
            $("#OnLineType").click();
