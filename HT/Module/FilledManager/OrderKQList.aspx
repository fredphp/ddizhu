<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderKQList.aspx.cs" Inherits="MTEwin.Module.FilledManager.OrderKQList" %>
...
<body>
  <form id="form1" runat="server">
      ...
      <tr>
        ...
        <td>
          ...
          <asp:DropDownList ID="ddlOrderStatus" runat="server">
            ...
            <asp:ListItem Value="2" Text="失败"></asp:ListItem>
          </asp:DropDownList>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg Tmg7">
      <tr>
        <td class="listTdLeft" style="width: 80px">订单查询：
        </td>
        <td>
    ...
    <div id="content">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
        <tr align="center" class="bold">
          ...
          <td class="listTitle2">交易日期
          </td>
          <td class="listTitle1">支付结果
          </td>
        </tr>
