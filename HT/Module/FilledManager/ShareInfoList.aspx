<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShareInfoList.aspx.cs" Inherits="MTEwin.Module.FilledManager.ShareInfoList" %>
...
<body>
  <form id="form1" runat="server">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
      <tr>
        <td class="listTdLeft" style="width: 80px">实付金额：
        </td>
        <td>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg Tmg7">
      <tr>
        ...
        <td>
          ...
          <input class="btnLine" type="button" />
          <input onclick="openWindowOwn('AddOrderTotal.aspx','AddOrderTotal',850,600)" value="添加补单" type="button" />
        </td>
      </tr>
    </table>
    <div id="content">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7" id="list">
        <tr align="center" class="bold">
          <td class="listTitle">充值时间
          </td>
          <td class="listTitle2">服务类型
          </td>
