<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaseRoleList.aspx.cs" Inherits="MTEwin.Module.BackManager.BaseRoleList" %>
        ...
        <tr>
            <td height="28">
                <ul>
                    ...
                    <li class="tab2" onclick="Redirect('WebConfig.aspx')">网站配置</li>
                </ul>
            </td>
        </tr>
    </table>  
            ...
            <asp:Repeater ID="rptRole" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">    
                        <td><%# (int)Eval("RoleID") == 1 ? "&nbsp;":"<input name='cid' type='checkbox' value='" + Eval("RoleID") + "'/>" %></td>
                        <td>                             
