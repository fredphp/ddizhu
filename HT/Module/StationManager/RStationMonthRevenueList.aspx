<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RStationMonthRevenueList.aspx.cs" Inherits="MTEwin.Module.StationManager.RStationMonthRevenueList" %>
  ...
  <form id="form1" runat="server">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
      <tr>
        ...
        <td width="1232" height="25" valign="top" align="left">你当前位置：分站系统 - 每月抽水记录
        </td>
      </tr>
    </table>
    ...
    <div id="content">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7" id="list">
        <tr align="center" class="bold">
          <td class="listTitle2">月份
          </td>
          <td class="listTitle">分站
          </td>
          <td class="listTitle">贡献抽水
          </td>
          <td class="listTitle">分站抽水
          </td>
        </tr>
