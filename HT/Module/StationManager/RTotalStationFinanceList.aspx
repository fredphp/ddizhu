<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RTotalStationFinanceList.aspx.cs" Inherits="MTEwin.Module.StationManager.RTotalStationFinanceList" %>
  ...
  <form id="form1" runat="server">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
      <tr>
        ...
        <td width="1232" height="25" valign="top" align="left">你当前位置：分站系统 - 收支明细记录
        </td>
      </tr>
    </table>
