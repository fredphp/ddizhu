<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfineMachineList.aspx.cs" Inherits="MTEwin.Module.AccountManager.ConfineMachineList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                ...
                <AlternatingItemTemplate>
                    <tr align="center" class="listBg" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td style="width: 100px;">
                            <a class="l" href="<%#"ConfineMachineInfo.aspx?id="+Eval("MachineSerial").ToString()+"&reurl="+ Game.Utils.Utility.CurrentUrl %>">
                                更新</a>
                            <a class="l" href="ConfineMachineList.aspx?cmd=del&param=<%#Eval("MachineSerial") %>" onclick="return confirm('确定要删除吗？')">删除</a>
                        </td>
                        <td>
