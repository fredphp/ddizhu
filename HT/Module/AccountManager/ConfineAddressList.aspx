<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfineAddressList.aspx.cs" Inherits="MTEwin.Module.AccountManager.ConfineAddressList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                ...
                <AlternatingItemTemplate>
                    <tr align="center" class="listBg" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td style="width: 100px;">
                            <a class="l" href="<%#"ConfineAddressInfo.aspx?id="+Eval("AddrString").ToString()+"&reurl="+ Game.Utils.Utility.CurrentUrl %>">
                                更新</a>
                            <a class="l" href="ConfineAddressList.aspx?cmd=del&param=<%#Eval("AddrString") %>" onclick="return confirm('确定要删除吗？')">删除</a>
                        </td>
                        <td>
