<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordUserInoutList.aspx.cs" Inherits="MTEwin.Module.AccountManager.RecordUserInoutList" %>
            ...
            <asp:Repeater ID="rptUserInout" runat="server" OnItemDataBound="rptUserInout_ItemDataBound">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td title="<%# Game.Utils.IPQuery.GetAddressWithIP( Eval("EnterClientIP").ToString())%>">
                            <%#Game.Utils.TextUtility.CutString( Game.Utils.IPQuery.GetAddressWithIP( Eval( "EnterClientIP" ).ToString( ) ), 0, 6 )%>
                        </td>
                        <td>
                        ...
                        <%# Eval( "LeaveTime" ) == DBNull.Value ? "<td></td>" : "<td title='"+Game.Utils.IPQuery.GetAddressWithIP( Eval( "LeaveClientIP" ).ToString( ))+"'>" + Game.Utils.TextUtility.CutString( Game.Utils.IPQuery.GetAddressWithIP( Eval( "LeaveClientIP" ).ToString( ) ), 0, 6 ) + "</td>"%>
