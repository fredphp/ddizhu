<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecoreAddScore.aspx.cs" Inherits="MTEwin.Module.AccountManager.RecoreAddScore" %>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtEndDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtStartDate\')}'})"></asp:TextBox><img
                    ...
                    style="cursor: pointer; vertical-align: middle" />
                     玩家:<asp:TextBox ID="txtSearchU" runat="server" CssClass="text" Width="100"></asp:TextBox>    
                      操作人:<asp:TextBox ID="txtSearchAdm" runat="server" CssClass="text" Width="100"></asp:TextBox>    
                ...
                <asp:CheckBox ID="cb_madel" runat="server"  Text="幸运币"/>
            ...
            <asp:Repeater ID="rptDataList" runat="server" >
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td >
                              <input type="text" style="border:0;background:none" readonly="true"  name='t1' value='<%#  Eval( "AddGold" )%>'   />
                        </td>
                        <td>
                             <%# Eval( "Reason" ) %>
                        </td>
...
<script type="text/javascript">
    ...
    function getsum(names) {
        ...
        for (var i = 0; i < list.length; i++)
            res = res + parseInt(list[i].value); //innerHTML
        return res;
    }
    function setTotalinfo() {
        var t1 = getsum("t1");
        var htmls = "手工赠送共计:" + t1;
        document.getElementById("showinfo").innerHTML = htmls;
