<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsRecordInfo.aspx.cs" Inherits="MTEwin.Module.AccountManager.AccountsRecordInfo" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            <td class="listTd" style="padding-left: 88px;">
                <a href="javascript:void(0)" class="l" onclick="javascript:openWindowOwn('RecordAccountsExpendList.aspx?param='+GetRequest('param',0),'RAccounts'+GetRequest('param',0),800,500);">
                    历史改名字记录</a>&nbsp;&nbsp;
                <a href="javascript:void(0)" class="l" onclick="javascript:openWindowOwn('RecordPasswdExpendList.aspx?param='+GetRequest('param',0),'RPassword'+GetRequest('param',0),800,500);">历史改密码记录</a>&nbsp;&nbsp;                 
            </td>
        </tr>
        <tr>
            <td height="35" class="f14 bold Lpd10 Rpd10">
        ...
        <tr>
            <td class="listTd" style="padding-left: 88px;">             
                ...
                <a href="javascript:void(0)" class="l" onclick="javascript:openWindowOwn('RecordInsureList.aspx?param='+GetRequest('param',0),'RInsure'+GetRequest('param',0),800,500);" >
                    <%=BankMoneyName%>记录</a>&nbsp;&nbsp;
                <a href="javascript:void(0)" class="l" onclick="javascript:openWindowOwn('ShareDetailList.aspx?param='+GetRequest('param',0),'ShareDetail'+GetRequest('param',0),800,500);" >
                    充值记录</a>&nbsp;&nbsp;
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="listTd" style="padding-left: 88px;">
                <a href="javascript:void(0)" class="l" onclick="javascript:openWindowOwn('StreamScoreInfoList.aspx?param='+GetRequest('param',0),'RScordInfo'+GetRequest('param',0),800,500);">
                    我的每日输赢记录</a>&nbsp;&nbsp;
                <a href="javascript:void(0)" class="l" onclick="javascript:openWindowOwn('RecordUserRevenueList.aspx?param='+GetRequest('param',0),'RRevenueInfo'+GetRequest('param',0),800,500);">
                    我的抽水记录</a>&nbsp;&nbsp;
                 <a href="javascript:void(0)" class="l" onclick="javascript:openWindowOwn('RecordUserFinanceList.aspx?param='+GetRequest('param',0),'RUserFinance'+GetRequest('param',0),800,500);">
                    我的抽水结算记录</a>&nbsp;&nbsp;
            </td>
        </tr>
        <tr>
