<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGrantTreasureList.aspx.cs" Inherits="MTEwin.Module.AccountManager.RecordGrantTreasureList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="titleOpBg Lpd10">
                <asp:CheckBox ID="cb_luckscore" runat="server" Text="查看赠送幸运币" AutoPostBack="true" />
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Convert.ToDouble( Eval( "CurGold" ).ToString( ) ) + Convert.ToDouble( Eval( "AddGold" ).ToString( ) )%>
                        </td>
                        <td>
