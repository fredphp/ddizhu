<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrantTreasure.aspx.cs" Inherits="MTEwin.Module.AccountManager.GrantTreasure" %>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
     <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAddGold" runat="server" CssClass="text wd4" MaxLength="16" onkeyup="if(isNaN(value))execCommand('undo');"></asp:TextBox>
            </td>
        </tr>
         <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:CheckBox ID="cb_addscore" runat="server" Text="从余额扣除" />
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
