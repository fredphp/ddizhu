<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAccount.aspx.cs" Inherits="MTEwin.Module.AccountManager.AddAccount" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtInsurePass" TextMode="Password" runat="server" CssClass="text wd4" MaxLength="20"></asp:TextBox>&nbsp;<%=BankMoneyName%>密码字符长度不可超过32个字符，不填则与登录密码相同
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:TextBox ID="txtInsurePass2" TextMode="Password" runat="server" CssClass="text wd4" MaxLength="20"></asp:TextBox>&nbsp;请再次输入<%=BankMoneyName%>密码
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtSpreaderScale" runat="server" CssClass="text wd4" Width="20" MaxLength="2" Text="10" onkeyup="if(isNaN(value))execCommand('undo');"></asp:TextBox>%&nbsp;
                比例最高可设置为89%&nbsp;&nbsp;&nbsp;
        ...
        <tr style="display: none;">
            ...
            <td>
                <asp:DropDownList ID="ddlMemberOrder" runat="server">
                    ...
                    <asp:ListItem Value="1">紫钻会员</asp:ListItem>
                    <asp:ListItem Value="2">黄钻会员</asp:ListItem>
                    <asp:ListItem Value="3">蓝钻会员</asp:ListItem>
                    <asp:ListItem Value="4">红钻会员</asp:ListItem>
                </asp:DropDownList>
                &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <td>
        <input name="in_MasterOrder" id="in_MasterOrder1" type="radio" value="0"checked='checked' /><label for="in_MasterOrder1">普通玩家</label>
        <input name="in_MasterOrder" id="in_MasterOrder2" type="radio" value="1" /><span style="color:#105399;font-weight:bold;"><label for="in_MasterOrder2">内部管理员</label></span>
        <input name="in_MasterOrder" id="in_MasterOrder3" type="radio" value="2" /><span style="color:#cd6a00;font-weight:bold;"><label for="in_MasterOrder3">外部管理员</label></span>
    </td>
</tr>
-->
        <tr style="display: none;">
