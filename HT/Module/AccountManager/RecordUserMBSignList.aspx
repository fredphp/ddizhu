<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordUserMBSignList.aspx.cs" Inherits="MTEwin.Module.AccountManager.RecordUserMBSignList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="titleOpBg Lpd10">
                <input type="button" value="签到配置" class="btn wd1" onclick="Redirect('UserMBSignConfig.aspx');" />
            ...
            <asp:Repeater ID="rptDataList" runat="server"  >
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%#( (DateTime) Eval( "InputDate" )).ToString() %>
