<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StreamScoreInfoDetailList.aspx.cs" Inherits="MTEwin.Module.AccountManager.StreamScoreInfoDetailList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
        <tr>
            ...
            <asp:DropDownList ID="ddlStation" runat="server"></asp:DropDownList>&nbsp;&nbsp;
                日期查询：
               <asp:TextBox ID="txtStartDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'txtEndDate\')}'})"></asp:TextBox><img
                ...
                至
                <asp:TextBox ID="txtEndDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'txtStartDate\')}'})"></asp:TextBox><img
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Eval( "FirstCollectDate" ,"{0:yyyy-MM-dd HH:mm:ss HH:mm:ss}")%>
                        </td>
                        <td>
                            <%# Eval( "LastCollectDate", "{0:yyyy-MM-dd HH:mm:ss HH:mm:ss}" )%>
                        </td>
                    </tr>
                </ItemTemplate>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>       
            <td align="right" class="page">        
                <gsp:AspNetPager ID="anpPage" runat="server" onpagechanged="anpPage_PageChanged" AlwaysShow="true" FirstPageText="首页" LastPageText="末页" PageSize="20" NextPageText="下页"
