<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignPlace.aspx.cs" Inherits="MTEwin.Module.AccountManager.AssignPlace" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlfirst" runat="server" CssClass="text wd4"></asp:DropDownList>
