<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfineAddressInfo.aspx.cs" Inherits="MTEwin.Module.AccountManager.ConfineAddressInfo" %>
...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtEnjoinOverDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})">
                </asp:TextBox><img src="../../Images/btn_calendar.gif" onclick="WdatePicker({el:'txtEnjoinOverDate',skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"
