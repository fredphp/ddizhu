<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AndroidInfo.aspx.cs" Inherits="MTEwin.Module.AccountManager.AndroidInfo" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        <tr>
            <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10">
                <div class="hg3  pd7">
                    <asp:Literal ID="litInfo" runat="server"></asp:Literal>配置机器人</div>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
        ...
        <tr>
            <td class="listTdLeft">
                机器人地址信息：            </td>
            <td>
                <asp:TextBox ID="txtAndroidNote" runat="server" CssClass="text" MaxLength="12"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
