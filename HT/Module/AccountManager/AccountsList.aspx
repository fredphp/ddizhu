<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsList.aspx.cs" Inherits="MTEwin.Module.AccountManager.AccountsList" %>
            ...
            if(deleteop()) {
                ...
                switch(opType) {
                    case "GrantTreasure":
                        ...
                        break;
                    case "btnGantUserMadel":
                        openWindowOwn('GrantUserMadel.aspx?param='+cid,'__GrantUserMadel',600,240);
                        break;
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
            <tr>
                ...
                <asp:TextBox ID="txtSearch" runat="server" CssClass="text" ToolTip="输入帐号或用户标识"></asp:TextBox>
                    ...
                    <input type="button" value="高级推广员" class="btn wd2" onclick="Redirect('AccountsList.aspx?cmd=spreader');" />
                    <input type="button" value="所有用户" class="btn wd2" onclick="Redirect('AccountsList.aspx');" />
                </td>
            </tr>
        </table>
        <div id="divQuery" class="querybox">
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="listTdLeft" style="width: 100px;">用户状态：
                    </td>
                    <td>
                        ...
                        <asp:CheckBox ID="ckbRefill" runat="server" Text="有充值" />
                        &nbsp;注册设备：
                    <asp:DropDownList ID="ddlDevice" runat="server">
                        <asp:ListItem Value="-1" Text="全部" Selected />
                        <asp:ListItem Value="0" Text="PC" />
                        <asp:ListItem Value="1" Text="iOS" />
                        <asp:ListItem Value="2" Text="Android" />
                    </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="listTdLeft" style="width: 100px;">注册日期：
                    </td>
                    <td>
                ...
                <tr>
                    <td class="listTdLeft" style="width: 100px;">登录日期：
                    </td>
                    <td>
                        <asp:TextBox ID="txtLoStartDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'txtLoEndDate\')}'})"></asp:TextBox><img
                            src="../../Images/btn_calendar.gif" onclick="WdatePicker({el:'txtStartDate',dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'txtLoEndDate\')}'})"
                            style="cursor: pointer; vertical-align: middle" />
                        至
                    <asp:TextBox ID="txtLoEndDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtLoStartDate\')}'})"></asp:TextBox><img
                        src="../../Images/btn_calendar.gif" onclick="WdatePicker({el:'txtEndDate',dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtLoStartDate\')}'})"
                        style="cursor: pointer; vertical-align: middle" />
                    </td>
                </tr>
                ...
                <tr style="display: none;">
                    <td class="listTdLeft" style="width: 50px;">现金余额：
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
            <tr>
                <td height="39" class="titleOpBg">
                    ...
                    <asp:Button ID="btnSetting" runat="server" Text="设置机器人" CssClass="btn wd2 hide" OnClick="btnSetting_Click" OnClientClick="return deleteop()" />
                    <asp:Button ID="btnCancle" runat="server" Text="取消机器人" CssClass="btn wd2 hide" OnClick="btnCancle_Click" OnClientClick="return deleteop()" />
                    <input class="btnLine" type="button" />
                    <input id="btnGantUserMadel" type="button" value="赠送幸运币" class="btn wd2" onclick="GrantManager('btnGantUserMadel')" />
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                <tr align="center" class="bold">
                    ...
                    <td class="listTitle2">性别</td>
                    <td class="listTitle2">余额</td>
                    <td class="listTitle2"><%=BankMoneyName%>余额</td>
                    <td class="listTitle2">幸运币</td>
                    <td class="listTitle2">一级比例</td>
                    <td class="listTitle2">直属上线</td>
                    <td class="listTitle2">直属站点</td>
                    <td class="listTitle2">注册时间</td>
                    <td class="listTitle2">注册地址</td>
                    <td class="listTitle2">注册设备</td>
                    <td class="listTitle2">登录次数</td>
                    <td class="listTitle2">游戏/在线时长</td>
                    <td class="listTitle2">最后登录时间</td>
                    <td class="listTitle2">最后登录地址</td>
                    <td class="listTitle1">状态</td>
                </tr>
                <asp:Repeater ID="rptDataList" runat="server">
                    <ItemTemplate>
                        <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default'" onmouseout="this.style.backgroundColor=currentcolor">
                            ...
                            <td>
                                <a class="l" href="javascript:void(0)" onclick="openWindowOwn('../AgencyManager/AddAgency.aspx?cmd=upAgency&param=<%#GetAgencyID((int)Eval("UserID"))%>','<%#GetAgencyID((int)Eval("UserID"))%>',950,600)"><%#GetAgencyID((int)Eval("UserID"))%></a>
                                <%#GetIsPaidStyle(int.Parse(Eval( "ParentID" ).ToString()))%>
                                <a class="l" href="javascript:void(0)" onclick="openWindowOwn('AccountsInfo.aspx?param=<%#Eval("ParentID") %>','<%#Eval("ParentID") %>',950,600)"><%# Game.Utils.TextUtility.CutString(GetAccounts(int.Parse(Eval("ParentID").ToString())),0,10)%></a>
                            </td>
                            <td>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="OpList">
            <tr>
                <td height="39" class="titleOpBg">
                    ...
                    <input class="btnGantUserMadel2" type="button" value="赠送幸运币" class="btn wd2" onclick="GrantManager('btnGantUserMadel')" />
