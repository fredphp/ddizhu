<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrantUserMadel.aspx.cs" Inherits="MTEwin.Module.AccountManager.GrantUserMadel" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAddGold" runat="server" CssClass="text wd4" MaxLength="16" onkeyup="if(isNaN(value))execCommand('undo');"></asp:TextBox>  <b>可以是负数</b>
            </td>
        </tr>
