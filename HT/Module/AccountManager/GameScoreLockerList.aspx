<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameScoreLockerList.aspx.cs" Inherits="MTEwin.Module.AccountManager.GameScoreLockerList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="display: <%=style%>">
            <tr>
                <td height="28">
                    <ul id="ul">
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <li class="tab2" onclick="Redirect('GameScoreLockerList.aspx?ServerID=<%# Eval("ServerID")%>')"><%# Eval("ServerName")%></li>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ul>
                </td>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
            <tr>
                ...
                <asp:DropDownList ID="ddlKindName" runat="server"></asp:DropDownList>&nbsp;
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                <tr align="center" class="bold">
                    ...
                    <td class="listTitle2">风控
                    </td>
                    <td class="listTitle">余额
                    </td>
                    <td class="listTitle">保险柜余额 
                    </td>
                    <td class="listTitle2">游戏
                    </td>
                    <td class="listTitle">房间
                    </td>
                    <td class="listTitle2">登录地址
                    </td>
                    <td class="listTitle">登录机器
                    </td>
                    <td class="listTitle2">进入时间
                    </td>
                    <td class="listTitle">时长
                    </td>
                </tr>
                <asp:Repeater ID="rptDataList" runat="server">
                    <ItemTemplate>
                        <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default'"
                            ...
                            <td>
                                ...
                                <%# GetUserMark((int)Eval("UserID")) + Eval("UserID")%>
                            </td>
                            <td>
                                <a href="AccountsInfo.aspx?param=<%#Eval("UserID") %>"><%#GetAccounts(int.Parse(Eval("UserID").ToString())) %></a>
                            </td>
                            <td style="background: <%#GetColor(Convert.ToInt32(Eval("amount"))-Convert.ToInt32(Eval("money")))%>">
                                <span></span>
                            </td>
                            <td>
                            ...
                            <td title="<%# Eval("EnterIP")%>">
                                <%# Game.Utils.IPQuery.GetAddressWithIP( Eval("EnterIP").ToString())%>
                            </td>
                            <td>
                                <%# Eval( "EnterMachine" )%>
                            </td>
                    ...
                    <AlternatingItemTemplate>
                        <tr align="center" class="listBg" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                            ...
                            <td>
                                <%#GetIsPaidStyle( int.Parse( Eval( "UserID" ).ToString( ) ) )%>
                                <%# GetUserMark((int)Eval("UserID")) + Eval("UserID").ToString()%>
                            </td>
                            <td>
                                <a href="AccountsInfo.aspx?param=<%#Eval("UserID") %>"><%#GetAccounts(int.Parse(Eval("UserID").ToString())) %></a>
                            </td>
                            <td style="background-color: <%#GetColor(Convert.ToInt32(Eval("amount"))-Convert.ToInt32(Eval("money")))%>">
                                <span></span>
                            </td>
                            <td>
                                <%#GetScoreByUserID(int.Parse( Eval( "UserID" ).ToString( )))%>
