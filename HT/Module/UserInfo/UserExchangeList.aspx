<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserExchangeList.aspx.cs" Inherits="MTEwin.Module.UserInfo.UserExchangeList" %>
          ...
          <ItemTemplate>
            <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
              ...
              <td style="width: 100px;">
                <a class="l" href="UserExchangeProcess.aspx?param=<%#base.IntParam+"&user="+Eval("Accounts")+"&param2="+Eval("RecordID") %>">审核</a>
              </td>
              <td>
                <%# Eval("CollectDate")%>
              </td>
