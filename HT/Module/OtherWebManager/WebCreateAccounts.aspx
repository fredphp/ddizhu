<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebCreateAccounts.aspx.cs" Inherits="MTEwin.Module.OtherWebManager.WebCreateAccounts" %>
  ...
  <form id="form1" runat="server">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
      <tr>
        ...
        <td width="1232" height="25" valign="top" align="left">你当前位置：外部网站系统 - 网站用户创建玩家管理
        </td>
      </tr>
    </table>
    <!-- 头部菜单 End -->
    ...
    <div id="content">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box"
        ...
        <tr align="center" class="bold">
          ...
          <td class="listTitle2">网站用户编号
          </td>
          <td class="listTitle2">玩家用户名
          </td>
          <td class="listTitle2">玩家编号
          </td>
