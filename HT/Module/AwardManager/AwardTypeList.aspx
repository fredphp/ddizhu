<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AwardTypeList.aspx.cs" Inherits="MTEwin.Module.AwardManager.AwardTypeList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('AwardTypeInfo.aspx?cmd=add')" />
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle2">类型名称</td>
                <td class="listTitle2">排序</td>     
                <td class="listTitle1">禁用状态</td>         
            </tr>
            <asp:Repeater ID="rptAwardType" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                    onmouseout="this.style.backgroundColor=currentcolor">
                        <td><input name='cid' type='checkbox' value='<%# Eval("TypeID")%>'/></td>      
                        <td>                             
                            <a class="l" href="AwardTypeInfo.aspx?cmd=edit&id=<%#Eval("TypeID") %>">更新</a>              
                        </td>                
                        <td><%# Eval("TypeName")%></td>
                        <td><%# Eval("SortID")%></td>
