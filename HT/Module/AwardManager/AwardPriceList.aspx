<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AwardPriceList.aspx.cs" Inherits="MTEwin.Module.AwardManager.AwardPriceList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('AwardPriceInfo.aspx?cmd=add')" />
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle1">排序</td>          
            </tr>
            <asp:Repeater ID="rptAwardPrice" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                    onmouseout="this.style.backgroundColor=currentcolor">
                        <td><input name='cid' type='checkbox' value='<%# Eval("PriceID")%>'/></td>      
                        <td>                             
                            <a class="l" href="AwardPriceInfo.aspx?cmd=edit&id=<%#Eval("PriceID") %>">更新</a>              
                        </td>                
                        <td><%# Eval("PriceName")%></td>
                        <td><%# Eval("SortID")%></td>
                    </tr>
                </ItemTemplate>
