<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AwardPriceInfo.aspx.cs" Inherits="MTEwin.Module.AwardManager.AwardPriceInfo" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="titleOpBg Lpd10">
                <input type="button" value="返回" class="btn wd1" onclick="Redirect('AwardPriceList.aspx')" />
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        <tr>
            <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10">
                <div class="hg3  pd7">
                    <asp:Literal ID="litInfo" runat="server"></asp:Literal>价格信息</div>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:TextBox ID="txtPriceName" runat="server" CssClass="text" validate="{required:true}"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
