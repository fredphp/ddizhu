<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailList.aspx.cs" Inherits="MTEwin.Module.AppManager.EmailList" %>
           ...
           <asp:TextBox ID="tb_serch" runat="server" CssClass="wd2"></asp:TextBox><input class="btnLine" type="button" /> 
            日期查询：
                ...
                <asp:TextBox ID="txtEndDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtStartDate\')}'})"></asp:TextBox><img
                    ...
                    <asp:ListItem Value="0" Text="系统给所有人" Selected="True"></asp:ListItem>
                    <asp:ListItem Value="1" Text="系统给某个人" ></asp:ListItem>
                  
                    </asp:DropDownList>
                    <!--  <asp:ListItem Value="2" Text="玩家给玩家"></asp:ListItem>-->
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="titleOpBg Lpd10">
                <input type="button" value="发送邮件" class="btn wd1" onclick="Redirect('EmialSend.aspx');" />
            ...
            <asp:Repeater ID="rptDataList" runat="server"  >
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                              <%# Eval("MailType").ToString() == "0" ? "所有人" : "玩家"%> 
                        </td>
                          <td>
                              <%# Eval("EMailTitle") %> 
                        </td>
                          <td>
                              <%# Eval("EMailContent").ToString().Length > 30 ? Eval("EMailContent").ToString().Substring(0, 30) + "..." : Eval("EMailContent").ToString()%> 
                        </td>
                         <td>
                            <a class="l" href="javascript:void(0);" onclick="openWindowOwn('EmailInfo.aspx?param=<%#Eval("RecordID").ToString() %>','email_<%#Eval("RecordID").ToString() %>',950,600);">
                                详情</a>
                        </td>
                    </tr>
                ...
                <AlternatingItemTemplate>
                        ...
                        <td>
                          ...
                          <td> <a class="l" href="javascript:void(0);" onclick="openWindowOwn('EmailInfo.aspx?param=<%#Eval("RecordID").ToString() %>','email_<%#Eval("RecordID").ToString() %>',950,600);">
                                详情</a>
                                </td>
                    </tr>
