<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameTypeItemInfo.aspx.cs" Inherits="MTEwin.Module.AppManager.GameTypeItemInfo" %>
   ...
   <Fox:Tab ID="fab1" runat="server" NavActivated="B"></Fox:Tab>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>        
                <asp:TextBox ID="txtTypeID" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo')"></asp:TextBox>               
            </td>
        </tr>
        <tr>
