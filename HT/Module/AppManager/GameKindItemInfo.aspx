<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameKindItemInfo.aspx.cs" Inherits="MTEwin.Module.AppManager.GameKindItemInfo" %>
...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>        
                <asp:TextBox ID="txtKindID" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo')"></asp:TextBox>               
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>        
                <asp:TextBox ID="txtSortID" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo')"></asp:TextBox> 
            </td>
        </tr>     
        <tr>
        ...
        <tr>
            ...
            <td>        
                <asp:TextBox ID="txtProcessName" runat="server" CssClass="text"></asp:TextBox> 
            </td>
        </tr>    
        <tr>
            <td class="listTdLeft">规则路径：</td>
            <td>        
                <asp:TextBox ID="txtGameRuleUrl" runat="server" CssClass="text"></asp:TextBox> 
            </td>
        </tr>  
        <tr>
            <td class="listTdLeft">下载路径：</td>
            <td>        
                <asp:TextBox ID="txtDownLoadUrl" runat="server" CssClass="text"></asp:TextBox> 
            </td>
        </tr>  
        <tr>
