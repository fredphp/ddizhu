<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpreadManager.aspx.cs" Inherits="MTEwin.Module.AppManager.SpreadManager" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# FormatMoney(GetSpreadScore( int.Parse( Eval( "ParentID" ).ToString( ) ) ))%>
                        </td>
                        <td>
