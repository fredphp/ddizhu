<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataBaseInfoInfo.aspx.cs" Inherits="MTEwin.Module.AppManager.DataBaseInfoInfo" %>
...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>        
                <asp:TextBox ID="txtDBAddr" runat="server" CssClass="text"></asp:TextBox>               
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">端口：</td>
            <td>        
                <asp:TextBox ID="txtDBPort" runat="server" CssClass="text"></asp:TextBox>               
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">用户名：</td>
            <td>        
                <asp:TextBox ID="txtDBUser" runat="server" CssClass="text"></asp:TextBox>               
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">密码：</td>
            <td>        
                <asp:TextBox ID="txtDBPassword" runat="server" CssClass="text" TextMode="Password" onchange="DBPwdChange()"></asp:TextBox>  
        ...
        <tr>
            ...
            <td>        
                <asp:TextBox ID="txtMachineID" runat="server" CssClass="text"></asp:TextBox>               
            </td>
        </tr>          
    </table>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
