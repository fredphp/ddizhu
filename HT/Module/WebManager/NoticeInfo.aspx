<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeInfo.aspx.cs" Inherits="MTEwin.Module.WebManager.NoticeInfo" %>
...
//*/
	KindEditor.ready(function(K) {
        ...
        function checkForm() {
            ...
            var endDate = document.getElementById("txtOverDate").value;
            if (startDate == "" || endDate == "") {
                showInfo("开始时间和结束时间不能为空")
                return false;
            }
        }
  </script>
  ...
  <form id="form1" runat="server" onsubmit="return checkForm()">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
      <tr>
        ...
        <td width="1232" height="25" valign="top" align="left">你当前位置：网站系统 - 公告管理</td>
      </tr>
    </table>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
      <tr>
        <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10">
          <div class="hg3  pd7">
            <asp:Literal ID="litInfo" runat="server"></asp:Literal>公告
          </div>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtStartDate" runat="server" CssClass="text"></asp:TextBox><img src="../../Images/btn_calendar.gif" onclick="WdatePicker({el:'txtStartDate',skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="cursor: pointer; vertical-align: middle" />
        </td>
      </tr>
      <tr>
        <td class="listTdLeft">结束时间：</td>
        <td>
          <asp:TextBox ID="txtOverDate" runat="server" CssClass="text"></asp:TextBox><img src="../../Images/btn_calendar.gif" onclick="WdatePicker({el:'txtOverDate',skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="cursor: pointer; vertical-align: middle" />
        </td>
      </tr>
      <tr>
