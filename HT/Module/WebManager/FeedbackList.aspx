<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackList.aspx.cs" Inherits="MTEwin.Module.WebManager.FeedbackList" %>
    ...
    <div id="content">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
        <tr align="center" class="bold">
          ...
          <td class="listTitle2">反馈标题</td>
          <td class="listTitle2">用户帐号</td>
          <td class="listTitle2">提交时间</td>
          <td class="listTitle2">提交地址</td>
          <td class="listTitle2">浏览次数</td>
          <td class="listTitle1">回复时间</td>
          <td class="listTitle1">回复人</td>
        ...
        <asp:Repeater ID="rptFeedback" runat="server">
          <ItemTemplate>
            <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
              ...
              <td><%# Eval("RevertDate")%></td>
              <td><%# (int)Eval("RevertUserID") == 0 ? "" : GetMasterName((int)Eval("RevertUserID"))%></td>
