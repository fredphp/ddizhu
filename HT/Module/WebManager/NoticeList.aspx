<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeList.aspx.cs" Inherits="MTEwin.Module.WebManager.NoticeList" %>
        ...
        <asp:Repeater ID="rptNotice" runat="server">
          <ItemTemplate>
            <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
              ...
              <td>
                <input name='cid' type='checkbox' value='<%# Eval("NoticeID")%>' /></td>
              <td>
