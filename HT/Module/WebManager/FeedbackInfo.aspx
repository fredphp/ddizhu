<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackInfo.aspx.cs" Inherits="MTEwin.Module.WebManager.FeedbackInfo" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
      <tr>
        <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10">
          <div class="hg3  pd7">
            <asp:Literal ID="litInfo" runat="server"></asp:Literal>反馈
          </div>
        </td>
      </tr>
      <tr>
        <td class="listTdLeft">反馈标题：
        </td>
        <td>
      ...
      <tr>
        <td class="listTdLeft">回复内容：
        </td>
        <td>
          <asp:TextBox ID="txtRevertContent" runat="server" TextMode="MultiLine" Width="600px" Height="150px" validate="{maxlength:300}"></asp:TextBox>
        </td>
      </tr>
      <tr>
        <td class="listTdLeft">回复人：
        </td>
        <td>
