<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgencyDrawRecord.aspx.cs" Inherits="MTEwin.Module.AgencyManager.AgencyDrawRecord" %>
    ...
    <script type="text/javascript">
        $(function () {
            $(".setSpan").click(function () { 
                ...
                $("#litTotalGold font").remove();
                $("#litGold font").remove();
                $("#litTotalGold").append("<font>" + $(this).attr("data-Total") + "</font>");
                $("#litGold").append("<font>" + $(this).attr("data-gold") + "</font>");
                $("#divQuery").show();
            });
        });
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%#  Eval("EndGold").ToString()%>
                        </td>
                        <td>
                            <%#  Eval("RevenueGold").ToString()%>
                        </td>
                        <td>
                            <%#  Eval("DrewTime").ToString()%>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class='<%# int.Parse(Eval("Result").ToString())==0?"setSpan":""%>' data-id='<%# Eval("DrawID") %>' data-gold='<%# Eval("DrawGold") %>' data-Total='<%# Eval("CurGold") %>'>设置</span>
                        </td>
                    </tr>
                </ItemTemplate>
