...
<body>
  <form id="form1" runat="server">
    ...
    <div id="content">
      <table width="100%" border="1" style="border-color: black;" align="center" cellpadding="0" cellspacing="0" class="box Tmg7" id="list">
        ...
        <asp:Repeater ID="rpData" runat="server">
          <ItemTemplate>
            <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
              ...
              <td><a href="#" class="l" onclick="openWindowOwn('MatchRankInfo.aspx?matchtype=<%# matchType%>&matchid=<%# Eval("MatchID") %>&serverid=<%# Eval("ServerID") %>&<%# matchType==0?"matchno="+Eval("MatchNo")+"&starttime="+Eval("MatchStartTime"):"matchno="+Eval("MatchNo") %>', 'MatchRankInfo', 800, 500);">查看详细排名</a></td>
