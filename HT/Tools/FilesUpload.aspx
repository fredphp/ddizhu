<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesUpload.aspx.cs" Inherits="MTEwin.Tools.FilesUpload" %>
...
<head id="Head1" runat="server">
  ...
  <style type="text/css">
    html, body, form { margin: 0px; padding: 0px; font-family: 微软雅黑; font-size: 12px; background: #caebfc; }
