<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MTEwin.Login" %>
...
<head id="Head1" runat="server">
  ...
  <title>网站管理后台</title>
  <style type="text/css">
    body { background-image: url(images/loginBg.jpg); font-family: "微软雅黑"; }
  </style>
</head>
<body>
  <br />
  ...
  <form id="form1" runat="server">
    <table width="705" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td style="background-image: url(images/login01.png); width: 705px; height: 50px;"></td>
      </tr>
      <tr>
        <td background="images/login02.png" width="705" height="235">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="73" height="33" class="f14" align="right">帐 号：
              </td>
            ...
            <tr>
              ...
              <td height="33" class="f14" align="right">密 码：
              </td>
              <td height="33">
            ...
            <tr>
              ...
              <td height="33" class="f14" align="right">验证码：
              </td>
              <td height="33">
            ...
            <tr>
              ...
              <td height="30" class="hui6">验证码请按下图中的数字填写
              </td>
            </tr>
            <tr>
              <td width="301" height="30">&nbsp;
      ...
      <tr>
        <td width="705" height="54" align="center" background="images/login03.png" style="color: #115287;"></td>
      </tr>
      <tr>
        <td style="background-image: url(images/login04.png); width: 705px; height: 46px;"></td>
      </tr>
      <tr>
        <td>
