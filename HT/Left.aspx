<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Left.aspx.cs" Inherits="MTEwin.Left" %>
...
<head id="Head1" runat="server">
  ...
  <script type="text/javascript">
    ...
    function GetUrl(obj,url) {
      window.open(url+'?'+Math.random(),"frm_main_content","",false);
      ...
      <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr>
          <td class="hui f14 bold pd32 hand" height="30" onclick="JavaScript:showHide(M_<%# Eval("ModuleID")%>);">
            <img src="images/arrBig.gif" width="11" height="11" id="S_<%# Eval("ModuleID")%>" />
            <%# Eval("Title")%>
          </td>
        </tr>
        <tr>
                ...
                <ItemTemplate>
                  <tr class="s" onclick="GetUrl(this,'<%# Eval("Link")%>')">
                    ...
                    <td width="67" height="25">
                      <img src="images/arrSmall.gif" width="8" height="7" /></td>
