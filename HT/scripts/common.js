...
function Show(obj,bShow) {
  ...
  obj=(typeof (obj)=="string"? S(obj):obj);
  if(obj) obj.style.display=(bShow? "block":"none");
}
...
function fMessageBox(msg,mbtype,bHide,hidetime,dialogTitle,win) {
  ...
  if(mbtype=="dialog") {
    ...
    var html="<span class='"+(mbtype=="success"? "msg":"errmsg")+"'>"+msg+"</span>";
    (CreateMessageBox()).innerHTML=html;
