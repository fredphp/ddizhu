		...
		<div class="am-g ap-pay">		
			<div class="am-u-lg-8 am-u-md-8 am-u-sm-12">
				...
				<form name="form" id="form" class="am-form ap-pay-form" onSubmit="return checkForm()" action="post.asp" method="post">	
					<label class="ap-pay-form-lable" for="username" >充值ID：</label><input class="ap-pay-form-input" id="username" name="username" type="text" value="<%=request("userid")%>" placeholder="请填写账号，必填" required/><br/>
					<label class="ap-pay-form-lable" for="username2">确认ID：</label><input class="ap-pay-form-input" id="username2" name="username2" type="text" value="<%=request("userid")%>" placeholder="请再次确认，必填" required/><br/>
					...
					<div class="ap-pay-item">
						...
						<div class="ap-pay-item-content">
							<input type="radio" name="paytype" value="qq-wap" id="qq-wap" checked>
							<label for="qq-wap">QQWAP</label>
						</div>
						<div class="ap-pay-item-content">
						...
						<div class="ap-pay-item-content">
							<label for="zhifubao-wap">微信充值请联系客服：yhz101804</label>
						</div>
						<!--<div class="ap-pay-item-content">
							<input type="radio" name="paytype" value="qqsm" id="qqsm">
							<label for="qqsm">QQ扫码</label>
						</div>
						<div class="ap-pay-item-content">
