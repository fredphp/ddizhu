<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TabUser.ascx.cs" Inherits="MTEwin.Themes.TabUser" %>
            ...
            <ul>
                ...
                <%-- 
                    ...
                    <% if (NavActivated == "E")
                       {
                        %>
                    <li class="tab1" onclick="Redirect('AccountUnderlingInfo.aspx?param='+GetRequest('param',0))">下级玩家</li>
                    <%}
                       else { %>
                    <li class="tab2" onclick="Redirect('AccountUnderlingInfo.aspx?param='+GetRequest('param',0))">下级玩家</li>
                    <%} %>     --%>
            </ul>
        </td>
    </tr>
